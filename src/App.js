  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img
          className="logo"
          src="https://thumbs.dreamstime.com/b/fast-food-phone-order-line-neon-icon-element-illustration-signs-symbols-can-be-used-web-logo-mobile-app-ui-ux-black-156783524.jpg"
        />
      </div>
